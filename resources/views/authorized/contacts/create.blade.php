<x-app-layout>
    ...
    <x-backend.main-container>
        ...
        <form class="flex flex-col justify-center items-center h-full" action="{{ route('contacts.store') }}" method="POST">
            @csrf
            <div class="!z-5 relative flex flex-col rounded-[20px] max-w-[300px] md:max-w-[400px] bg-clip-border shadow-3xl shadow-shadow-500 w-full !p-6 3xl:p-![18px] bg-white undefined">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="site_name" name="site_name" :value="old('site_name')" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="site_logo_big_text" name="site_logo_big_text" :value="old('site_logo_big_text')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="site_logo_small_text" name="site_logo_small_text" :value="old('site_logo_small_text')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="address" name="address" :value="old('address')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="google_maps_link" name="google_maps_link" :value="old('google_maps_link')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" id="email" name="email" :value="old('email')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="facebook_acc" name="facebook_acc" :value="old('facebook_acc')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="instagram_acc" name="instagram_acc" :value="old('instagram_acc')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="twitter_acc" name="twitter_acc" :value="old('twitter_acc')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="linkedin_acc" name="linkedin_acc" :value="old('linkedin_acc')" placeholder="" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
