<x-app-layout>
    ...
    <x-backend.main-container>
        ...
        <form class="flex flex-col justify-center items-center h-full" action="{{ route('services.update', $service) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="!z-5 relative flex flex-col rounded-[20px] max-w-[300px] md:max-w-[400px] bg-clip-border shadow-3xl shadow-shadow-500 w-full !p-6 3xl:p-![18px] bg-white undefined">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="section_desc" name="section_desc" value="{{ $service->section_desc }}" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="section_heading" name="section_heading" value="{{ $service->section_heading }}" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="body" name="body" value="{{ $service->body }}" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="article_heading" name="article_heading" value="{{ $service->article_heading }}" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="article_body" name="article_body" value="{{ $service->article_body }}" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="author" name="author" value="{{ $service->author }}" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
