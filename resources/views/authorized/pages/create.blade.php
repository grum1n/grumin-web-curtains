<x-app-layout>
    ...
    <x-backend.main-container>
        ...
        <form class="flex flex-col justify-center items-center h-full" action="{{ route('pages.store') }}" method="POST">
            @csrf
            <div class="!z-5 relative flex flex-col rounded-[20px] max-w-[300px] md:max-w-[400px] bg-clip-border shadow-3xl shadow-shadow-500 w-full !p-6 3xl:p-![18px] bg-white undefined">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="name" name="name" :value="old('name')" class="mt-2 flex h-12 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none border-gray-200">
