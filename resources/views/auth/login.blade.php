            ...
            <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
                <div class="flex-1">
                    <div class="flex flex-col justify-start items-center">
                        ...
                        <p class="mt-3 text-gray-500 dark:text-gray-300">{{ __('Vartotojo paskyra') }}</p>
                    </div>
                    ...
                    <div class="mt-8">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mt-6">
                                <div class="flex justify-between mb-2">
                                    <label for="password" class="text-sm text-gray-600 dark:text-gray-200">{{ __('Slaptažodis') }}</label>
                                    <a href="#" class="text-sm text-gray-400 focus:text-blue-500 hover:text-blue-500 hover:underline">{{ __('Užmiršote slaptažodį?') }}</a>
                                </div>
                            ...
                            <div class="block mt-4">
                                <label for="remember_me" class="flex items-center">
                                    ...
                                    <span class="ml-2 text-sm text-gray-400">{{ __('Prisiminti mane') }}</span>
                                </label>
                            </div>
                        ...
                        <p class="mt-6 text-sm text-center text-gray-400">Dar neturite paskyros? <a href="{{ route('register') }}" class="text-blue-500 focus:outline-none focus:underline hover:underline">{{ __('Registruotis') }}</a>.</p>
                    </div>
                </div>
            </div>
        </div>
