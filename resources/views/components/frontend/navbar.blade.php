    ...
    <div 
        ...
        <div class="flex justify-between h-full">
            ...
            <div class="hidden  lg:flex  items-center">
                <a class="flex gap-2 items-center py-1 md:py-3 pl-1 text-xl font-medium align-middle text-lime-50 hover:text-lime-200 no-underline " href="tel:{{ $contacts->phone_number_1 }}">
