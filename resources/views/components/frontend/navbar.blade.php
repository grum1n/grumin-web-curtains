<nav x-data="{ open: false }" class="fixed w-full top-0 md:pt-10 z-50" id="navigation">
    ...
    <div class="max-w-7xl mx-auto px-0 bg-gradient-to-r from-emerald-950 to-lime-600 drop-shadow-[0_1px_0_rgba(0,0,0,0.25)]">
        <div class="flex justify-between h-full">
            ...
            <div class="hidden  lg:flex  items-center">
                <a class="flex gap-2 items-center py-1 md:py-3 pl-1 text-xl font-medium align-middle text-stone-800 no-underline hover:text-red-100" href="tel:{{ $contacts->phone_number_1 }}">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1 min-h-screen w-full top-0 z-50 border-t-2 border-gray-400 px-4 bg-emerald-950">
            ...
            <x-responsive-nav-link href="/" :frontendGalleryactive="request()->routeIs('/')">
                {{ __('Galerija') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="/" :active="request()->routeIs('/')">
                {{ __('Kontaktai') }}
